...
class Hotel
{
    public static void Main(string[] args)
    {
        ...
        if (orderIds.Count > 0)  
        {
            ...
            Console.WriteLine("***** SHRAVANI's HOTEL *******");
            Console.WriteLine("-------------------------------------------------");
            Console.WriteLine("Address :: A.nagar, Maharashtra - 423109, INDIA ");
            Console.WriteLine("===================================================");
            Console.WriteLine();
            ...
            Console.WriteLine("-------------------------------------------------");
            Console.WriteLine("BILLING AMOUNT :: " + total);
            Console.WriteLine("===================================================");
        }
    }
}